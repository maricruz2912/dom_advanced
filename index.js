...
//aquí traemos la función del html
let total_update= document.getElementById("total_total");
console.log(total_update.textContent);
...
function updateSubtotal(product) {
  ...
  // }
   ...
   products.forEach(function(product) {
    ...
    total_update.textContent = grandTotal;
  ...
  function createProduct() {
    ...
    newProductItem.querySelector(`.btn-delete`).addEventListener(`click`, removeProduct);
